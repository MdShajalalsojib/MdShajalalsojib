...
I'm a Computer Science & Engineering student who enjoys building clean, functional, and beautiful web applications. I love turning ideas into real products with a strong focus on UI, usability, and problem solving.
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=html,css,js,react,tailwind,nodejs,express,mongodb,mysql,figma,c,python,java" />
</p>
...
|---|---|---|
| Programming Basics | C-Programming | C |
| OOP Practice | CPP-ProgrammingPractice | C++ |
| Programming Basics | Java-Programming | Java |
| Database | Database-System-Lab | MySQL |
| Frontend Practice | HTML_CSS_Project | HTML, CSS |
| Data Science | Gub_project | Jupyter Notebook |
